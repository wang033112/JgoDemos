...
/**
 * Created by ke-oh on 2019/07/25.
 *
 */

public class WaterProgress extends ProgressBar {
    ...
    private void getAttrValue(AttributeSet attrs) {
        ...
        mCircleColor = ta.getColor(R.styleable.WaterProgressView_circle_color, ContextCompat.getColor(mContext, R.color.colorPrimary));
        mProgressColor = ta.getColor(R.styleable.WaterProgressView_progress_color,ContextCompat.getColor(mContext, R.color.dodgerblue));
        mTextColor = ta.getColor(R.styleable.WaterProgressView_text_color,DEFAULT_TEXT_COLOR);
        mTextSize = (int) ta.getDimension(R.styleable.WaterProgressView_text_size, DEFAULT_TEXT_SIZE);
        mRippleTop = (int) ta.getDimension(R.styleable.WaterProgressView_ripple_topheight,Utils.dip2px(DEFAULT_RIPPLE_TOPHEIGHT));
